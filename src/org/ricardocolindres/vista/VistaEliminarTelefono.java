 ...
 * @author colin
 */
public class VistaEliminarTelefono extends javax.swing.JInternalFrame {
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        Telefono rol = new Telefono();
        rol.setIdTelefono(Integer.parseInt(txtIdEliminar.getText()));
        rol.setEstadoTelefono(false);

        ControlDeTelefono controlador = new ControlDeTelefono();
        controlador.eliminarTelefono(rol);
