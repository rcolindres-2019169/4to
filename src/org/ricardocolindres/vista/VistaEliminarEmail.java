 ...
 * @author colin
 */
public class VistaEliminarEmail extends javax.swing.JInternalFrame {

    /**
     * Creates new form VistaEliminarEmail
     */
    public VistaEliminarEmail() {
        initComponents();
    }
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        Email rol = new Email();
        rol.setIdEmail(Integer.parseInt(txtIdEliminar.getText()));
        rol.setEstadoEmail(false);

        ControlDeEmail controlador = new ControlDeEmail();
        controlador.eliminarEmail(rol);
