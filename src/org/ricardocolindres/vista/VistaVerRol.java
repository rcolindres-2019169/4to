 ...
 * @author colin
 */
public class VistaVerRol extends javax.swing.JInternalFrame {
    private final ControlDeRol controlador = ControlDeRol.getInstancia();
    /**
     * Creates new form VistaVerRol
     */
    public VistaVerRol() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scrollpanel, javax.swing.GroupLayout.DEFAULT_SIZE, 693, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void mostrarLibrosEnTabla(){        
        ...
        for(int i=0; i<cantidadDeRegistros; i++){
            Rol libro = controlador.listaDeDireccions().get(i);
            tablaDeLibros.setValueAt(libro.getIRol(), i, 0);
            tablaDeLibros.setValueAt(libro.getRol(), i, 1);
