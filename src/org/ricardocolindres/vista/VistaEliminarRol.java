 ...
 * @author colin
 */
public class VistaEliminarRol extends javax.swing.JInternalFrame {

    /**
     * Creates new form VistaEliminarRol
     */
    public VistaEliminarRol() {
        initComponents();
    }
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        Rol rol = new Rol();
        rol.setIdRol(Integer.parseInt(txtIdEliminar.getText()));
        rol.setEstadoRol(false);
        
        ControlDeRol controlador = new ControlDeRol();
        controlador.eliminarRol(rol);
